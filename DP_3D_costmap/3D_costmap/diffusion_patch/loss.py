...
class StandardDiffusionLoss(nn.Module):
    ...
    학습 목표: Slope + Height map을 보고 에너지 효율적 경로를 생성하도록 학습
    - Input: Slope + Height 2채널 map (물리적 경사 정보 + 높이 정보)
    - GT 경로: A* 알고리즘이 Height 비용으로 찾은 에너지 효율적 경로
    - 모델: Slope와 Height 정보를 모두 활용하여 최적 경로의 패턴을 학습
    """
