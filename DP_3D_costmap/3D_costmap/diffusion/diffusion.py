...
with Slope + CoT 2-channel costmap conditioning.
Model receives both Slope and CoT information as input.
"""
...
class DiffusionScheduler:
    ...
    def sample(self, 
        ...
        Args:
            ...
            condition (torch.Tensor): 조건 (2-channel costmap) [B, 2, H, W] - [Slope, CoT]
        ...
        for i in iterator:
            ...
            if start_pos is not None and end_pos is not None:
                ...
                current_start = start_pos.unsqueeze(1)  # [B, 1, 2]
                current_end = end_pos.unsqueeze(1)      # [B, 1, 2]
