...
# 실제 데이터 포인트 (빨간색 삼각형)
plt.scatter(measured_x, measured_y, color='red', marker='^', s=80, label='Measured CoT samples')

# 그래프 스타일 설정 (논문과 유사하게)
plt.title('Slope vs Cost of Transport', fontsize=18)
plt.xlabel('Signed Slope angle (deg)', fontsize=15)
plt.ylabel('Value (CoT)', fontsize=15)
